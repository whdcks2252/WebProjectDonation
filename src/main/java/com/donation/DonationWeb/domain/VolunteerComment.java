...
@Getter
public class VolunteerComment extends ObjectTime{
    @Id
    @GeneratedValue
    @Column(name="volunteer_comment_num")
    private Long id;
    ...
    @Builder
    public VolunteerComment(String content, Member member, VolunteerPost volunteerPost) {
